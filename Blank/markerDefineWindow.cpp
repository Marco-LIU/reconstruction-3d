...
//------------------------------------------------------------------------------
void MarkerDefineWindow::addToPredefineWindow() {
  
}
//------------------------------------------------------------------------------
void MarkerDefineWindow::markerUp() {
  //返回当前选择的项
...
//------------------------------------------------------------------------------
void MarkerDefineWindow::markerDown() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::markerEdit() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::markerAdd() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::markerDelete() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::lineUp() {
  //返回当前选择的项
...
//------------------------------------------------------------------------------
void MarkerDefineWindow::lineDown() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::lineEdit() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::lineAdd() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::lineDelete() {

}
//------------------------------------------------------------------------------
void MarkerDefineWindow::lineAutoGen() {
