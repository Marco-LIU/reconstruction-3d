...
typedef void(*SetGpuInfoFuncT)(const base::StringPiece& vendor_id, const base::StringPiece& device_id,
...
BASE_EXPORT void ksSetGpuInfoReprotingFunction(SetGpuInfoFuncT set_gpu_info_func);
BASE_EXPORT void ksSetGpuInfo(const base::StringPiece& vendor_id, const base::StringPiece& device_id,
  const base::StringPiece& driver_version, const base::StringPiece& pixel_shader_version,
  const base::StringPiece& vertex_shader_version);


typedef void(*SetExtensionIDT)(int index, const base::StringPiece& id);
BASE_EXPORT void ksSetExtensionIDInfoFunction(SetExtensionIDT set_extension_id_func);
BASE_EXPORT void ksSetExtensionID(int index, const base::StringPiece& id);


typedef void(*SetNumberOfExtensionsT)(int number_of_extensions);
BASE_EXPORT void ksSetNumberOfExtensionFunction(SetNumberOfExtensionsT set_extentsion_num_func);
BASE_EXPORT void ksSetNumberOfExtensions(int number_of_extensions);


typedef void(*SerCommandlineInfoT)(const wchar_t** argv, size_t argc);
BASE_EXPORT void ksSetCommandLineInfoFunction(SerCommandlineInfoT set_commandline_func);
BASE_EXPORT void ksSetCommandLine(const wchar_t** argv, size_t argc);
